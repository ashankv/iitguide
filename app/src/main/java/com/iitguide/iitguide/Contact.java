...
public class Contact extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem menuItem) {
        ...
        if(menuItem.getItemId() == R.id.student_portal){
            Intent facintent = new Intent(Contact.this, CourseActivity.class);
            startActivity(facintent);
        }

        if(menuItem.getItemId() == R.id.logout){
            Intent logIntent = new Intent(Contact.this, MainActivity.class);
        ...
        if(menuItem.getItemId() == R.id.question_answer){
            Intent facintent = new Intent(Contact.this, QuestionAnswer.class);
            startActivity(facintent);
        }

        if(menuItem.getItemId() == R.id.faculty_directory){
            Intent facintent = new Intent(Contact.this, FacDirect.class);
            startActivity(facintent);
        }
